...
function App () {
  ...
  const movies= [
    {
        ...
        rating:4.5 ,
        id: Math.random(),
        videoTrailer:  "https://www.youtube.com/embed/ssWbGKTgXFc",
    },
    {
      title:"THE X-FILES" ,
     ...
     posterUrl: "https://images-na.ssl-images-amazon.com/images/I/51QB68KSHEL.jpg" ,
      rating:3 ,
      id: Math.random(),
      videoTrailer:"https://www.youtube.com/embed/KKziOmsJxzE",
  ...
  },
  {
    ...
    rating:"5" ,
    id:  Math.random(),
    videoTrailer:  "https://www.youtube.com/embed/1joMwOjPmyE",
},
...
return (
  ...
  <div>
    ...
    <div className='container-fluid movie-app'>
      <div className='row'> 
    <Route  path={"/:title"} render={(props) => <MovieDetails {...props} data= {movies} />}>
    </Route>
    </div> </div>
   <Footer />
    </div>
